"""
Django settings for testpino_49 project.
...
WSGI_APPLICATION = 'testpino_49.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testpino_49 API",
    "DESCRIPTION": "API documentation for testpino_49 App",
    "VERSION": "v1",
}
